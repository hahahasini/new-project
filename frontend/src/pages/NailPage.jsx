...
function NailPage() {
  ...
  return (
    <main className="model-page animate-fade-in" id="nail-page">
      <div className="container">

        <div className="page-header animate-fade-in-up">
          <Link to="/" className="back-btn" id="nail-back-btn">← Back to Models</Link>
          <div className="page-header-content">
            <div className="page-header-img-wrap page-header-img-wrap--indigo">
              <img src="/nail-icon.png" alt="Fingernail" className="page-header-img" />
            </div>
            <div>
              <h1 className="page-title">Nail Analysis</h1>
